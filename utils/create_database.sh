...
psql -U postgres -d $DB_NAME -c "alter table spatial_ref_sys owner to $USER"
psql -U postgres -d $DB_NAME -c "alter table geometry_columns owner to $USER"
psql -U postgres -d $DB_NAME -c "alter table geography_columns owner to $USER"
